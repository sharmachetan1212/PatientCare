...
const AboutHome = () => {
  ...
  return (
    <div className="body w-full ">
        ...
        <div className="">
          <div>
            ...
            <div className=" lg:grid grid-cols-3 ml-20 mt-12">
              <div className="shadow-sm border-2 mt-12 pt-12 rounded-md w-9/12 hover:shadow-xl">
                <div className="flex justify-center">
                  <img
                    src={tushar}
                    alt="admin_profile"
              ...
              <div className="shadow-sm border-2 mt-12 p-12 rounded-md w-9/12 hover:shadow-xl">
                <div className="flex justify-center">
                  <img
                    src={aman}
                    alt="admin_profile"
      ...
      <div className="mt-60 py-3 relative bottom 0">
        <Footer></Footer>
      </div>
    </div>
  );
