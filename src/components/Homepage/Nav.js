  ...
  return (
    <nav className="bg-white w-screen h-14 shadow-sm px-16 lg:py-3 flex justify-items-center items-center">
        ...
        <ul className="flex ml-auto lg:w-60 justify-evenly  font-lato font-semibold w-64 ">
          <li>
            <Link to="/home" className="text-[17px] mr-11">Home</Link>
          </li>
          <li>
            <Link to="/about" className="text-[17px] mr-10">About</Link>
          </li>
          <li>
            <Link to="/contact" className="text-[17px] mr-10">Contact</Link>
          </li>
        </ul>
        <button
        ...
        >
          <Link to="/home/new-post">My Blog</Link>
        </button>
        <button
          className="bg-primary py-2 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary ml-6"
          onClick={handleLogout}
