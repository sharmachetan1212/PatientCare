    ...
    <div className="body w-full ">
      ...
      <div className="bg-secoundry ">
        ...
        <div className="lg:grid lg:grid-cols-2 mt-4 ">
          <div>
            <div className="max-w-full  lg:mx-32 my-20 bg-white py-8 px-16 rounded-3xl  border-8 border-primary">
              ...
              <div className="">
                ...
                <h1 className="font-poppins text-xl">sharmachetan1212@gmail.com</h1>
              </div>
              <div>
                <h1 className="font-bold font-poppins text-2xl mt-4 ">
                  Address :
        ...
        <div className="mt-[206px] py-3 relative bottom 0">
          <Footer></Footer>
        </div>
      </div>
    </div>
